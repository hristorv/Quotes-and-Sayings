...
public class ImageGridRecyclerAdapter extends
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TextView likesBar = (TextView) itemView.findViewById(R.id.likesBar);
        likesBar.setCompoundDrawablesWithIntrinsicBounds(tintDrawable(R.drawable.likes, R.color.primary_color), null, null, null);
